...
% 'greens.jpg'
% 'hands1.jpg'
% 'C:\Users\jinu\Dropbox\My PC (DESKTOP-4UNBIL6)\Desktop\2.tiff'
% 'cameraman.tif'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


mypic = imread('C:\Users\jinu\Dropbox\My PC (DESKTOP-4UNBIL6)\Desktop\2.tiff');
subplot(4,2,2);
imshow(mypic)
...
stdy=std(pixelCounts); %calculate standard deviation of channel.
